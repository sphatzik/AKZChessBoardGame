...
{
    RWTreeNodeValueType _valueX;
    RWTreeNodeValueType _valueY;
}

@property (nonatomic) RWTreeNodeValueType valueX;
@property (nonatomic) RWTreeNodeValueType valueY;
- (id) initWithValue:(RWTreeNodeValueType) valueX valueY:(id)valueY;
- (NSString* ) dump;
@end
