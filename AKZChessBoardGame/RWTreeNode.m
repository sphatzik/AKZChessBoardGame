...
- (id) initWithValue:(id) valueX valueY:(id) valueY
{
    self = [super init];
    _valueX = valueX;
    _valueY = valueY;
...
{
    return [NSString stringWithFormat:@"<%@:%p - valueX:%@ valueY:%@>\n",NSStringFromClass(self.class),self,[_valueX description],[_valueY description]];
}
